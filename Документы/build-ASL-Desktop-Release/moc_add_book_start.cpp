...
#include "../ASL-tryNotCry/add_book/add_book_start.h"
...
const QMetaObject Add_book_start::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Add_book_start.data,
      qt_meta_data_Add_book_start,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Add_book_start::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Add_book_start.stringdata0))
        return static_cast<void*>(const_cast< Add_book_start*>(this));
